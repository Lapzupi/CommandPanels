...
public class OpenPanelsLoader {
    ...
    */
    public final Map<String, PanelsInterface> openPanels = new HashMap<>(); //player name and panel interface
    public final Set<String> skipPanelClose = new HashSet<>(); //don't remove the player if they are in this list
    ...
    public void closePanelForLoader(String playerName, PanelPosition position) {
        ...
        if (openPanels.get(playerName).allClosed() || openPanels.get(playerName).getPanel(PanelPosition.TOP) == null) {
